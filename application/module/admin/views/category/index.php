...
<?php
    ...
    $th_row             =   $th_ID. $th_Name. $th_Picture. $th_Status. $th_Ordering. $th_created. $th_modified. $th_action;
    ...
    foreach($items as $value){
        ...
        $imgPicture             =   (file_exists(HTD_PATH.$this->dirImgPicture.PIC_CATEGORY[2].$value['picture'])) ? $this->dirImgPicture.PIC_CATEGORY[2].$value['picture'] : $this->dirImgPicture.'60x90-default.jpg';
