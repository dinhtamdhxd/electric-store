<?php 
    ...
    $link           =   (isset($this->arrParam['form']['link']))    ? $this->arrParam['form']['link'] : '';
    ...
    $inputLink          =   HTML::cmsInputForm('form[link]', 'text', $link);
    ...
    $linkRow            =   HTML::cmsRowForm('Link', $inputLink);
    ...
    $formTable          =   $nameRow. $descriptionRow. $linkRow. $pictureRow. $statusRow. $orderingRow. $inputHiddenRow;
...
<div class="card card-info" style="width: 700px; margin: auto;">
    <div class="card-header">
        <h3 class="card-title">Change Info Slider</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
