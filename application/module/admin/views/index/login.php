    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body card card-info card-outline login-card-body">
                ...
                <form action="index.php?module=admin&controller=index&action=login" method="post" name="form-login">
                    <div class="input-group mb-3">
                        <input type="email" name="form[email]" class="form-control" placeholder="Email" value="<?php echo $this->arrParam['form']['email'] ?? ''; ?>">
