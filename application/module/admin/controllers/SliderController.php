<?php
    class SliderController extends Controller{
        ...
        public function indexAction(){
            ...
            $arrPagination                  =   ['pageRange' => '3', 'totalItemsPerPage' => '2', 'currentPage' => $currentPage];
            ...
            $this->_view->dirImgPicture     =   FILES_URL.$this->_controller.DS.'images/'.PIC_SLIDER[2].DS;
        ...
        public function formAction(){
            ...
            $dirImgPicture  =   FILES_URL.$this->_controller.DS.'images/'.PIC_SLIDER[2].DS;
            if(isset($this->_arrParam['id'])){
                $id                         =   $this->_arrParam['id'];
                $infoUser                   =   $this->_model->infoItem($id);
                $this->_arrParam['form']    =   $infoUser;
                $this->_view->srcpicture    = (file_exists(HTD_PATH.$dirImgPicture.PIC_SLIDER[2].$infoUser['picture'])) ? $dirImgPicture.PIC_SLIDER[2].$infoUser['picture'] : $dirImgPicture.'60x90-default.jpg';
            ...
            if(isset($this->_arrParam['form']['token']) &&  $this->_arrParam['form']['token'] > 0){
                ...
                if($this->_validate->isValid()){
                    ...
                    $folderUpload   =   $this->_controller.DS.'images/'.PIC_SLIDER[2].DS;
                    ...
                    if(isset($_FILES['picture']) && $_FILES['picture']['name'] != ''){
                        ...
                        $uploadObj->removeFile($folderUpload, PIC_SLIDER[2].$picturename);
                        $this->_arrParam['form']['picture']  =   $uploadObj->uploadFile($fileUpload, $folderUpload, PIC_SLIDER[0], PIC_SLIDER[1]);
                    }
