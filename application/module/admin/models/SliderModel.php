...
{
    private $columns    =   ['id', 'name', 'description', 'link', 'picture', 'created', 'created_by', 'modified', 'modidied_by', 'status', 'ordering'];
    public function __construct()
    {
        parent::__construct();
        $this->setTable(TBE_SLIDER);
    }
    ...
    {
        $query  =   "SELECT `id`, `name`, `description`, `link`, `picture`, `status`, `ordering` FROM `$this->table` WHERE `id` = '$id' ";
